...
TIBS bars are persisted to TimescaleDB in the `mart.fact__tick_imbalance` table. The `interval` column distinguishes between small/large profiles and TIBS vs TRBS.
