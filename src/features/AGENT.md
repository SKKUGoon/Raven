...
Time-based candles are sourced from **Binance Klines** (1m) via `binance_futures_klines` and stored in `warehouse.bar__kline`. TimescaleDB continuous aggregates handle upsampling (5m, 15m, 1h, etc.).
